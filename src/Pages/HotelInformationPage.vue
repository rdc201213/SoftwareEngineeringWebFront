...
<template>
    <el-container style="background-color:#f5f7fa;">
      ...
      <el-main style="overflow:unset;padding:0;">
        <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top:50px;margin-bottom:50px;">
          <el-breadcrumb-item style="color: #409EFF;" :to="{ path: '/' }">首页</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/' }">酒店列表</el-breadcrumb-item>
          <el-breadcrumb-item :to="{ path: '/' }">{{hotel.hotelName}}</el-breadcrumb-item>
        </el-breadcrumb>
          ...
          <el-dialog
              ...
              <el-form ref="newOrderForm" :model="newOrderForm" label-width="150px">
                <el-form-item label="用户名">
                  <el-input v-model="userName" style="width:250px" placeholder="暂无用户名称" disabled></el-input>
                </el-form-item>
                <el-form-item label="酒店名">
                  <el-input v-model="hotel.hotelName" style="width:250px" placeholder="暂无酒店名称" disabled></el-input>
                </el-form-item>
                <el-form-item label="房间类型">
                  <el-input v-model="currentType" style="width:250px" placeholder="暂无房间类型" disabled></el-input>
                </el-form-item>
                <el-form-item label="价格(￥)">
                  <el-input v-model="currentPrice" style="width:250px" placeholder="暂无价格" disabled></el-input>
                </el-form-item>
                <el-form-item label="联系方式">
                  <el-input v-model="newOrderForm.phoneNumber" style="width:250px" placeholder="请输入您的手机号"></el-input>
                </el-form-item>
              ...
              <div style="margin-top:50px;margin-left:350px">
                ...
                <el-button type="primary" icon="" v-on:click="newOrder()" size="small">提交</el-button>
              </div>
            </el-dialog>
          ...
          <div class="detail-headline_container">
            <div class="detail-headline_base">
              ...
              <div class="detail-headline_address">
                <i class="u-icon" type="locate">{{hotel.province}}，{{hotel.city}}，{{hotel.district}}</i>
              </div>
            </div>
            <div class="detail-head-price_container">
              <el-button href="#roomlist" class="select_room" type="primary">选择房间</el-button>
            </div>
          </div>
          <div class="detail-headcontext">
            <div class="detail-headcontext_picture">
              <img :src="hotel.photoURL" alt="" class="pic" style="width:500px;height:285px;float:left;">
            </div>
            <div class="detail-headcontext_title" style="float:left;margin:30px 30px;height:225px;">{{hotel.introduction}}</div>
          </div>
        </el-card>
            ...
            <div class="detail-headline_container">
              <div class="soloroom roomlist-baseroom-card" style="width:100%display:inline-block;float:left;padding-bottom: 22px;width:100%;border-right: 1px solid #dadfe6;">
                <div class="roompanel" style="">
                  <img :src="room.photoURL" alt="" class="pic" style="width:100px;height:85px;float:left;padding-right:30px;">
                  <div class="roomtype" style="padding-top:100px;font-weight:bold;">{{room.roomType}}</div>
                </div>
              </div>
              <div style="width:3400px;padding-left:50px;padding-top:20px;font-size:20px;flex:auto;display:flex;flex-direction:row;justify-content: flex-end;">{{room.specialService}}。</div>
              <div style="width:1000px;padding-top:20px;font-size:20px;flex:auto;display:flex;flex-direction:row;justify-content: flex-end;">￥{{room.price}}</div>
              <div class="detail-head-price_container" style="flex:auto;display:flex;flex-direction:row;justify-content: flex-end;">
                <el-button v-on:click="addOrder(room.roomType,room.price)" style="height:60px;" class="select_room" type="primary">提交订单</el-button>
              </div>
            </div>
          </el-card>
        </div>
