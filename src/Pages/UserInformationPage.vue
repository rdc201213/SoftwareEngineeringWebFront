...
.main-contain{background-image: linear-gradient(#f38237, #ffffff);
...
.tt{margin-top: 60px;}
.filePic{width:100px; float:left;margin-left:500px;margin-top:15px ;}	
.center{width:100%; margin:0px auto;min-height: 1px; overflow:hidden;}
.inputPic{ width:100px; float:left;margin-left:200px;margin-top:15px ;cursor:pointer;opacity:0;ilter:alpha(opacity=0);z-index: 9;}
