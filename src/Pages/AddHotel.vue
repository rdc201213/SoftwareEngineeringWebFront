  ...
  <div>
    ...
    <div class="left-items" style="float: left">
      <el-input
        ...
        style="width: 200px"
      ></el-input>
      <el-button style="margin-left: 10px" v-on:click="searchHotel()"
        >查询</el-button
      >
    </div>
    <div class="right-items" style="float: right">
      <el-button style="margin-left: 10px" v-on:click="addressForm()"
        >添加</el-button
      >
    </div>
    <el-table :data="tableData" style="width: 100%">
      <el-table-column prop="hotelID" label="酒店ID" width="180">
      </el-table-column>
      <el-table-column prop="roomID" label="房间ID" width="180">
      </el-table-column>
      <el-table-column prop="roomType" label="房间类型" width="180">
      </el-table-column>
      <el-table-column prop="startTime" label="起始日期" width="180">
      </el-table-column>
      <el-table-column prop="endTime" label="终止日期" width="180">
      </el-table-column>
      <el-table-column prop="price" label="价格" width="180"> </el-table-column>
      <el-table-column prop="specialService" label="特殊服务">
      </el-table-column>
    </el-table>
